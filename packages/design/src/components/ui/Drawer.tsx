...
>(({ shouldScaleBackground = true, alwaysOpen = false, ...props }, ref) => (
...
>(({ className, children, noOverlay = false, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ref={ref}
      className={cn(
        'bg-background fixed inset-x-0 bottom-0 z-50 flex h-auto flex-col border',
        className
      )}
      {...props}
    >
      {/* TODO: align this properly based of data-vaul-drawer-direction */}
